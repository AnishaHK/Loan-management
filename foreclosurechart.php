...
if(isset($_POST['submit']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		$msg= str_replace(" ","%20","Your Foreclosure payment to $txtloanacno has been made on "  . $dts  . " for the amount of Rs. ". $paymentamt. " and Your Loan account has been closed. Thank You for Payment.. -MyLoanee");
		$ch = curl_init();
