...
<?php
$mobno=$_GET['mobno'];
$msg= str_replace(" ","%20","Thanks for Registration. Your MyLoanee One Time Password(OTP) verification code is $randomotp. Don't share it with anyone. OTP is valid for 15 minutes...");//test%20message
$ch = curl_init();
