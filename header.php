...
?>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="viewcompanies.php">VIEW COMPANIES</a>
      </div>
    </li>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="user.php">ADD STAFF</a>
        <a class="dropdown-item" href="viewuser.php">VIEW STAFF</a>
      </div>
    </li>
...
<header>
	<div class="container">
		<div class="header d-lg-flex justify-content-between align-items-center py-lg-3 px-lg-3">
			<!-- logo -->
			<div id="logo">
				<h1><a href="index.php"><span class="fa fa-suitcase mr-2"></span>DBIT Banky</a></h1>
			</div>
			<!-- //logo -->
			<div class="w3pvt-bg">
				<!-- nav -->
