...
if($rs['comp_name'] == "")
{
$msg= str_replace(" ","%20","Hello $rs[cst_fname] $rs[cst_lname], Your login ID is $rs[cst_email] and Password is  $rs[cst_password] -MyLoanee");
}
if($rs['cst_fname'] == "")
{
$msg= str_replace(" ","%20","Hello $rs[comp_name], Your login ID is $rs[cst_email] and Password is  $rs[cst_password] -MyLoanee..");
}
$ch = curl_init();
...
<html>
<head>
<title>MyLoanee - Password Recovery Panel</title>
<link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
<script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
...
<body id="LoginForm">
<div class="container">
<center><h1 class="form-heading" style="cursor: pointer;" onclick="window.location='index.php'">myLoanee</h1></center>
