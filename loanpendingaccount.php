...
<div class="row">
	...
	<div class="col-md-9">
		<input type="email" name="cst_resemail" id="cst_resemail" class="form-control"  value="<?php echo $lacc_resaddr[3]; ?>"   >
	</div>
</div>
<br>
...
<div class="read-icon">
	...
	<div class="col-lg-6 col-md-6 mt-6" style="text-align: right;"><input type="submit" name="submit" class="btn btn-success" value="Approve Loan Application"></a></div>	
</div>
                        </div>
                    </div>
                </div>
