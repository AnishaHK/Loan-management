            ...
            <div class="footer-top text-center">
                <h2>
                    <a class="navbar-brand" href="index.php">
                        <span class="fa fa-suitcase"></span> DBIT BAnky
                    </a>
                </h2>
            </div>
        </div>
    ...
    <div class="copy-right">
        <div class="container">
            <div class="row">
                <p class="copy-right-grids text-md-left text-center my-sm-4 my-4 col-md-6">© <?php echo date("Y"); ?> DBIT BAnky. nishant and dhanush All Rights Reserved 
                </p>
<?php
